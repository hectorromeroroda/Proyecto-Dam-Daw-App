...
public class AdaotadorAllOtherCommunitiesBD extends AdaptadorAllOtherCommunities{
    public Cursor cursor;


    public AdaotadorAllOtherCommunitiesBD(Context contexto, Communitie communitie, Cursor cursor) {
    ...
    @Override
    public void onBindViewHolder(AdaotadorAllOtherCommunitiesBD.ViewHolder holder, int posicion) {
